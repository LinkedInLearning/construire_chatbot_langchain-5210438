...
#print(get_cake_price("Angel"))
#print(get_cake_sugar("Angel"))
...
#inputs = {"messages":[HumanMessage("What are the pricing for Profiterole cake?") ]}

#inputs = {"messages":[HumanMessage("Give me a list of 5 available cake names?")]}

#inputs = {"messages":[HumanMessage("Can you provide me with a list of cakes that have a sugar content below 40%?")]}

#inputs = {"messages":[HumanMessage("Can you provide me with a list of cakes that have a sugar content below 40%, along with their sugar percentage?")]}

#inputs = {"messages":[HumanMessage("How many cakes are there in total?")]}
